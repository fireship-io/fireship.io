...
<button on:click={signInWithApple}>
    <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" version="1.1" x="0px" y="0px" width="814px" height="1000px" viewBox="0 0 814 1000" enable-background="new 0 0 814 1000" xml:space="preserve">
...
<style>
    button {
        @apply bg-white font-sans text-black inline-flex text-base shadow-md px-4 py-3 my-0.5 w-full cursor-pointer border-none;
    }
    svg {
        @apply w-5 h-5 mr-2 relative top-0.5;
    }
</style>