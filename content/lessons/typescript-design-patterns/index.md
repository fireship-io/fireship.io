...
A facade is a class that provides a simplified API for a larger body of code. It is often used to hide low-level details of a subsystem.
...
The mediator pattern provides a middle layer between objects that communicate with each other. This pattern is frequently implemented in JavaScript libaries via plugin systems (like Webpack) and middleware (like Express).
