...
Option B - Login with with the Firebase _GoogleAuthProvider_ and add additional scopes. This will grant us permission, but we will need to manage access and refresh tokens manually.
