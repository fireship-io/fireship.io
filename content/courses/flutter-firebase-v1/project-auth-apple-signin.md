...
Add the _Sign In with Apple_ capability from Xcode. Make sure to include it on all your build types.
...
Enable the _Apple_ authentication method in Firebase. Do not worry about the OAuth flow, it is only required for web apps.
